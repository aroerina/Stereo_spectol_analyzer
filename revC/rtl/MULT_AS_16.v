...
/* Module Version: 4.0 */
/* C:\lscc\diamond\1.2\ispfpga\bin\nt\scuba.exe -w -n MULT_AS_16 -lang verilog -synth synplify -bus_exp 7 -bb -arch mg5a00 -type dspmadd -widtha 16 -widthb 16 -widthsum 33 -gsr ENABLED -area -madd -signed -rega0 -rega0clk CLK0 -rega0ce CE0 -rega0rst RST0 -rega1 -rega1clk CLK0 -rega1ce CE0 -rega1rst RST0 -regb0 -regb0clk CLK0 -regb0ce CE0 -regb0rst RST0 -regb1 -regb1clk CLK0 -regb1ce CE0 -regb1rst RST0 -regsa1 -regsa1clk CLK0 -regsa1ce CE0 -regsa1rst RST0 -regsb1 -regsb1clk CLK0 -regsb1ce CE0 -regsb1rst RST0 -regp0 -regp0clk CLK0 -regp0ce CE0 -regp0rst RST0 -regp1 -regp1clk CLK0 -regp1ce CE0 -regp1rst RST0 -rego -regoclk CLK0 -regoce CE0 -regorst RST0 -clk0 -ce0 -rst0 -e  */
/* Sat Jun 11 14:47:00 2011 */


`timescale 1 ns / 1 ps
module MULT_AS_16 (CLK0, CE0, RST0, A0, A1, B0, B1, SUM);
    input wire CLK0;
    input wire CE0;
    input wire RST0;
    input wire [15:0] A0;
    ...
    MULT18X18ADDSUBB dsp_0 (.A017(A0[15]), .A016(A0[14]), .A015(A0[13]), 
        ...
        .CE0(CE0), .CE1(scuba_vhi), .CE2(scuba_vhi), .CE3(scuba_vhi), .CLK0(CLK0), 
        ...
        .SROB1(), .SROB0(), .SUM36(SUM[32]), .SUM35(SUM[31]), .SUM34(SUM[30]), 
        .SUM33(SUM[29]), .SUM32(SUM[28]), .SUM31(SUM[27]), .SUM30(SUM[26]), 
        .SUM29(SUM[25]), .SUM28(SUM[24]), .SUM27(SUM[23]), .SUM26(SUM[22]), 
        .SUM25(SUM[21]), .SUM24(SUM[20]), .SUM23(SUM[19]), .SUM22(SUM[18]), 
        .SUM21(SUM[17]), .SUM20(SUM[16]), .SUM19(SUM[15]), .SUM18(SUM[14]), 
        .SUM17(SUM[13]), .SUM16(SUM[12]), .SUM15(SUM[11]), .SUM14(SUM[10]), 
        .SUM13(SUM[9]), .SUM12(SUM[8]), .SUM11(SUM[7]), .SUM10(SUM[6]), 
        .SUM9(SUM[5]), .SUM8(SUM[4]), .SUM7(SUM[3]), .SUM6(SUM[2]), .SUM5(SUM[1]), 
        .SUM4(SUM[0]), .SUM3(), .SUM2(), .SUM1(), .SUM0())
