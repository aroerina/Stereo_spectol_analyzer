...
/* Module Version: 2.4 */
/* C:\lscc\diamond\1.2\ispfpga\bin\nt\scuba.exe -w -lang verilog -synth synplify -bus_exp 7 -bb -arch mg5a00 -type rom -addr_width 9 -num_rows 512 -data_width 7 -outdata REGISTERED -memfile c:/dev/source/hdl/fpgaproject/ipex/diff_quaternegativecosine16b512d.mem -memformat hex -e  */
/* Mon Aug 22 16:31:35 2011 */


`timescale 1 ns / 1 ps
module DISTROM_DIFFNCOS7b512d_for_16b2048d (Address, OutClock, 
    OutClockEn, Reset, Q);
