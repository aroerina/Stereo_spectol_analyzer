...
/* Module Version: 6.1 */
/* C:\lscc\diamond\1.2\ispfpga\bin\nt\scuba.exe -w -lang verilog -synth synplify -bus_exp 7 -bb -arch mg5a00 -type bram -wp 10 -rp 0011 -rdata_width 9 -data_width 9 -num_rows 16 -outdata REGISTERED -resetmode SYNC -cascade -1 -e  */
/* Fri Aug 19 16:01:13 2011 */


`timescale 1 ns / 1 ps
module DPRAM9b16d (WrAddress, RdAddress, Data, WE, RdClock, RdClockEn, 
    ...
    defparam DPRAM9b16d_0_0_0.CSDECODE_B =  3'b000 ;
    defparam DPRAM9b16d_0_0_0.CSDECODE_A =  3'b000 ;
    defparam DPRAM9b16d_0_0_0.WRITEMODE_B = "NORMAL" ;
    defparam DPRAM9b16d_0_0_0.WRITEMODE_A = "NORMAL" ;
    defparam DPRAM9b16d_0_0_0.GSR = "DISABLED" ;
    defparam DPRAM9b16d_0_0_0.RESETMODE = "SYNC" ;
    defparam DPRAM9b16d_0_0_0.REGMODE_B = "OUTREG" ;
    defparam DPRAM9b16d_0_0_0.REGMODE_A = "OUTREG" ;
    defparam DPRAM9b16d_0_0_0.DATA_WIDTH_B = 9 ;
    defparam DPRAM9b16d_0_0_0.DATA_WIDTH_A = 9 ;
    // synopsys translate_on
    DP16KB DPRAM9b16d_0_0_0 (.DIA0(Data[0]), .DIA1(Data[1]), .DIA2(Data[2]), 
        ...
        .DOB11(), .DOB12(), .DOB13(), .DOB14(), .DOB15(), .DOB16(), .DOB17())
             /* synthesis MEM_LPC_FILE="DPRAM9b16d.lpc" */
    ...
    // exemplar begin
    // exemplar attribute DPRAM9b16d_0_0_0 MEM_LPC_FILE DPRAM9b16d.lpc
    // exemplar attribute DPRAM9b16d_0_0_0 MEM_INIT_FILE 
    // exemplar attribute DPRAM9b16d_0_0_0 CSDECODE_B 0b000
    // exemplar attribute DPRAM9b16d_0_0_0 CSDECODE_A 0b000
    // exemplar attribute DPRAM9b16d_0_0_0 WRITEMODE_B NORMAL
    // exemplar attribute DPRAM9b16d_0_0_0 WRITEMODE_A NORMAL
    // exemplar attribute DPRAM9b16d_0_0_0 GSR DISABLED
    // exemplar attribute DPRAM9b16d_0_0_0 RESETMODE SYNC
    // exemplar attribute DPRAM9b16d_0_0_0 REGMODE_B OUTREG
    // exemplar attribute DPRAM9b16d_0_0_0 REGMODE_A OUTREG
    // exemplar attribute DPRAM9b16d_0_0_0 DATA_WIDTH_B 9
    // exemplar attribute DPRAM9b16d_0_0_0 DATA_WIDTH_A 9
    // exemplar end
