...
/* Module Version: 4.0 */
/* D:\lscc\diamond\1.2\ispfpga\bin\nt\scuba.exe -w -n MULT_HANW -lang verilog -synth synplify -bus_exp 7 -bb -arch mg5a00 -type dspmult -widtha 16 -widthb 17 -widthp 33 -gsr ENABLED -area -signed -unsignedb -rego -regoclk CLK0 -regoce CE0 -regorst RST0 -clk0 -ce0 -rst0 -e  */
/* Wed Jul 27 23:21:08 2011 */


`timescale 1 ns / 1 ps
module MULT_HANW (CLK0, CE0, RST0, A, B, P);
    input wire CLK0;
    input wire CE0;
    input wire RST0;
    input wire [15:0] A;
    ...
    MULT18X18B dsp_0 (.A17(A[15]), .A16(A[14]), .A15(A[13]), .A14(A[12]), 
        ...
        .A1(scuba_vlo), .A0(scuba_vlo), .B17(B[16]), .B16(B[15]), .B15(B[14]), 
        .B14(B[13]), .B13(B[12]), .B12(B[11]), .B11(B[10]), .B10(B[9]), 
        .B9(B[8]), .B8(B[7]), .B7(B[6]), .B6(B[5]), .B5(B[4]), .B4(B[3]), 
        .B3(B[2]), .B2(B[1]), .B1(B[0]), .B0(scuba_vlo), .SIGNEDA(scuba_vhi), 
        ...
        .SROB1(), .SROB0(), .P35(P[32]), .P34(P[31]), .P33(P[30]), .P32(P[29]), 
        .P31(P[28]), .P30(P[27]), .P29(P[26]), .P28(P[25]), .P27(P[24]), 
        .P26(P[23]), .P25(P[22]), .P24(P[21]), .P23(P[20]), .P22(P[19]), 
        .P21(P[18]), .P20(P[17]), .P19(P[16]), .P18(P[15]), .P17(P[14]), 
        .P16(P[13]), .P15(P[12]), .P14(P[11]), .P13(P[10]), .P12(P[9]), 
        .P11(P[8]), .P10(P[7]), .P9(P[6]), .P8(P[5]), .P7(P[4]), .P6(P[3]), 
        .P5(P[2]), .P4(P[1]), .P3(P[0]), .P2(), .P1(), .P0())
